...
:::caution
When writing your options types, be sure to be very explicit about them, specifically concerning
optional properties. Make sure to specify `undefined` as a possible value:
