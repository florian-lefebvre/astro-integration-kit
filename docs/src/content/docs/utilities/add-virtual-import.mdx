...
:::note
Whilst you can choose any name for your virtual module, it's a good idea to stick to this convention as much as possible:

- If the module is an "internal" module, as in it will only be used by you in your integration, then follow this pattern: `virtual:${ integrationName }/${ moduleName }`
