    ...
    return {
        ...
        hooks: {
            "astro:config:setup": ({ updateConfig }) => {
                addVirtualImport({
                    name: 'my-integration/config', // this will now be importable with `virtual:my-integration/config`
                    content: {
                        foo: 'bar',
                    },
                    updateConfig,
...
Now you can easily share state across your integration 🎉!
...
Now you'll have perfect typing when importing your virtual modules 👏!