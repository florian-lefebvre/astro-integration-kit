...
`addDevToolbarPlugin` allows you to register a framework component as a Dev Toolbar Plugin!

So now you can use a React, Preact, Solid, Vue or Svelte component as a Dev Toolbar Plugin,
instead of having to create your DOM manually yourself!
...
<h1 class="p-4 mb-4 font-black">Hello, world!</h1>
```
