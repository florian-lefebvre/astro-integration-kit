...
description: A powerful wrapper around the standard Astro Integrations API. It allows to handle options and global logic easily.
---
import Disabled from "~/components/Disabled.astro"
import { LinkCard } from '@astrojs/starlight/components';

`defineIntegration` is a powerful wrapper around the standard Astro Integrations API. It allows to handle options and global logic easily.
