...
Some official Astro tools, like [`@astrojs/db`](https://docs.astro.build/en/guides/integrations-guide/db/), define new integration hooks that are not built into Astro core. AIK, by default, don't integrate with those hooks.

If you want to use those hooks on your integration, you can import that extra behavior when defining your integration:
